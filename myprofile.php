...
<body>
  ...
  <div class=" divider"></div>
            ...
            <script type="text/javascript">
              ...
              let token = window.localStorage.getItem("data_token"); // get item token from login 

              fetch('http://localhost/app_connection/app-connection-p2p/development/crud/getProfileData.php', {
                  method: "GET",
                ...
                .then(function(json) {
                  ...
                  //json parse array
                  let result_data = JSON.parse(JSON.stringify(json))["profile"];

                  if (result == 200) {

                    console.log("data : " + result_data.fullname); ///get email

                    document.getElementById("result_email").innerHTML = result_data.email;
                    document.getElementById("result_name").innerHTML = result_data.fullname;
                    document.getElementById("result_mobileno").innerHTML = result_data.mobileno;
                    document.getElementById("result_address").innerHTML = result_data.address;
                  }
                })
                    ...
                    <form method="POST" action="myprofileup.php?id=<?php echo $id ?>">
                      ...
                      <!-- <div class="row row-space">
                        ...
                        <div class="col-2">
                          <div class="input-group">
                            <b>Last Name</b>
                            <input class="input--style-1" type="text" name="lastName" value="" readonly>
                          </div>
                        </div>
                      </div> -->
                      ...
                      <div class="row row-space">
                        ...
                        <div class="input-group">
                          <b>Full Name</b>
                          <p id="result_name" style="color: black;">
                            <!-- DATA -->
                        </div>
                      ...
                      <div class="input-group">
                        <b>Email</b>
                        <!-- <input class="input--style-1" type="email" name="email" value=" " readonly> -->
                        <p id="result_email" style="color: black;">
                          <!-- DATA -->
                      </div>
                      <div class="row row-space">
                        <div class="col-2">
                      ...
                      <b>Contact Number</b>
                      <div class="input-group">
                        <p id="result_mobileno" style="color: black;">
                          <!-- DATA -->
                      </div>
                      ...
                      <div class="input-group">
                        <b>Address</b>
                        <p id="result_address" style="color: black;">
                          <!-- DATA -->
                      </div>
