          ...
          if($old == $employee['password']){
            ...
            mysqli_query($conn, $sql);
             echo ("<SCRIPT LANGUAGE='JavaScript'>
                ...
                window.location.href='myprofile2.php?id=$id';</SCRIPT>"); 
...
<html>
<head>
  <title>Change Password | Animal Adoption System</title>
  <!-- Icons font CSS-->
        ...
        <div class="wrapper wrapper--w680">
            <div class="card card-1">
                ...
                <div class="card-body">
                    ...
                    <form id = "registration" action="changepassemp2.php" method="POST">

                          <div class="row row-space">
                            <div class="col-2">
                                <div class="input-group">
                                  <p>Old Password</p>
                                     <input class="input--style-1" type="text" name = "oldpass" required >
                                </div>
                            </div>
                            <div class="col-2">
                                <div class="input-group">
                                  <p>New Password</p>
                                    <input class="input--style-1" type="text" name="newpass" required>
                                </div>
                            </div>
                        </div>
