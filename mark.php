                    ...
                    <form id = "registration" action="mark.php" method="POST">
                        ...
                        <div class="row row-space">
                            <div class="col-2">
                                <div class="input-group">
                                  <p>Due Date</p>
                                     <input class="input--style-1" type="text" name="duedate" value="<?php echo $duedate;?>" >
                                </div>
                            </div>
                            <div class="col-2">
                                <div class="input-group">
                                  <p>Hours Worked</p>
                                    <input class="input--style-1" type="time" name="subdate" value="<?php echo $subdate;?>">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="p-t-20">
                            <button class="btn btn--radius btn--green" type="submit" name="update">OK</button>
                        </div>
